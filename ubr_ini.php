...
$TEMP_DIR                    = $config['base_dir'].'/media/dir_upload/';

$UBER_VERSION                = '6.3.8';                      // Version of Uber-Uploader
...
$DEFAULT_CONFIG              = 'ubr_video_config.php';     // Path info
$PATH_TO_JS_SCRIPT           = 'js/forms/uploader.js';         // Path info
