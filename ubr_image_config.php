...
$config['allowed_image_formats'] = str_replace(' ', '', $config['allowed_image_formats']);

$_CONFIG['config_file_name']                      = 'ubr_image_config';
...
$_CONFIG['max_upload_size']                       = $config['max_image_size']*1024*1024;
$_CONFIG['overwrite_existing_files']              = 0;
$_CONFIG['redirect_url']                          = $config['base_url']. '/upload_image';
...
$_CONFIG['allow_extensions']                      = '(' .str_replace(',', '|', $config['allowed_image_formats']). ')';
