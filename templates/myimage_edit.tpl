...
<table cellpadding=0 cellspacing=0 border=0 align=center class="width950b">
	...
	<td>
		...
		<tr><td class="grey">
			...
			<tr>
			    <form name="vupdate_form" action="{$base_url}/my_images" method="post" encType="multipart/form-data">
			    <td valign=top>
				<fieldset>
				...
				<table width="100%" cellpadding=2 cellspacing=0 border=0>
					...
					{if $multi_categ_uploads ne "0"}
						...
						{if $smarty.request.categlist eq ""}
						    {insert name=list_categ_all_image assign=chinfo vid=$VID}
