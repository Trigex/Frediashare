			...
			<table cellpadding=0 cellspacing=0 border=0 align="left" width="100%">
				...
				<td class="" valign="top" align="left" width="185">
				    <select name="actions" class="selbox" onchange="if(this.selectedIndex == '1') {ldelim} HideContent('btn1x'); ShowContent('btn2x'); {rdelim} else {ldelim} ShowContent('btn1x'); HideContent('btn2x'); {rdelim}">
				...
				<td class="pl5" valign="bottom" align="left">
				    <div id="btn1x" style="display: block;"><input type="submit" name="goact" value="{$btn_apply}" class="fb"></div>
				    <div id="btn2x" style="display: none;" class="">
					...
					<table cellpadding="0" cellspacing="0" border="0" align="left" width="100%">
						...
						<tr>
						    <td width="1%"><input type="checkbox" name="lpl[]" value="{$upl[i].vkey}"></td>
