		...
		<tr>
			...
			<div class="cursor">                                                                                                                                                                   
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td valign="middle" class="pl5" width="11">
                                                    <div id="cdownarr2" style="display: {if $smarty.session.menu_browsev eq "block" or $smarty.session.menu_browsev eq ""}block{else}none{/if};" class="pl2">
                                                        <a href="javascript:void(0)" onclick="c_m2(); set_hpsess('menu_browsev');"><img src="{$img_url}/arrowdown1.gif" width="9" height="5" alt=""></a>
                                                    </div>
                                                    <div id="cleftarr2" style="display: {if $smarty.session.menu_browsev eq "none"}block{else}none{/if};" class="pl2">
                                                        <a href="javascript:void(0)" onclick="c_m2(); set_hpsess('menu_browsev');"><img src="{$img_url}/arrowleft1.gif" width="5" height="9" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>&nbsp;<a href="javascript:void(0)" onclick="c_m2(); set_hpsess('menu_browsev');"><span id="mmh12" class="{if $smarty.session.menu_browsev eq "none"}{else}act{/if}">{$mmenu_item5}</span></a></td>
                                            </tr>
                                        </table>
                                        <div id="cspacer2" style="display: {$smarty.session.menu_browsev};"><table cellpadding="0" cellspacing="0"><tr><td height="5"></td></tr></table></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div id="mmenulist2" style="display: {$smarty.session.menu_browsev};">
                        ...
                        <div align="center" id="cbottom2" style="display: {if $smarty.session.menu_browsev eq "none"}block{else}none{/if};">{if $site_theme eq "black"}<img src="{$img_url}/bottomcorners2.gif" width="{$thimgwidth}" height="6" alt="">{else}<img src="{$img_url}/bottomcorners.gif" width="{$thimgwidth}" height="6" alt="">{/if}</div>
		    </td>
		</tr>
                {/if}