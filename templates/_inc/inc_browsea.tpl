		...
		<tr>
			...
			<div class="cursor">
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td valign="middle" class="pl5" width="11">
                                                    <div id="cdownarr3" style="display: {if $smarty.session.menu_browsea eq "block" or $smarty.session.menu_browsea eq ""}block{else}none{/if};" class="pl2">
                                                        <a href="javascript:void(0)" onclick="c_m3(); set_hpsess('menu_browsea');"><img src="{$img_url}/arrowdown1.gif" width="9" height="5" alt=""></a>
                                                    </div>
                                                    <div id="cleftarr3" style="display: {if $smarty.session.menu_browsea eq "none"}block{else}none{/if};" class="pl2">
                                                        <a href="javascript:void(0)" onclick="c_m3(); set_hpsess('menu_browsea');"><img src="{$img_url}/arrowleft1.gif" width="5" height="9" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>&nbsp;<a href="javascript:void(0)" onclick="c_m3(); set_hpsess('menu_browsea');"><span id="mmh13" class="{if $smarty.session.menu_browsea eq "none"}{else}act{/if}">{$mmenu_item3}</span></a></td>
                                            </tr>
                                        </table>
                                        <div id="cspacer3" style="display: {$smarty.session.menu_browsea};"><table cellpadding="0" cellspacing="0"><tr><td height="5"></td></tr></table></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div id="mmenulist3" style="display: {$smarty.session.menu_browsea};">
                    		...
                    		{if $file_ratings eq "1"}<tr><td><a href="{if $smarty.session.UID eq "" and $guests_file_sorting eq "0"}{$base_url}/login?next={$rem}{$smarty.request.user}/top_rated{else}{$base_url}/{if $smarty.request.category ne ""}categories/audio/{$smarty.request.category}{else}{$ulnk}audios{/if}{if $smarty.request.user ne ""}/{$smarty.request.user}{/if}/top_rated{/if}">{$toprated}</a></td></tr>{/if}
                        ...
                        <div align="center" id="cbottom3" style="display: {if $smarty.session.menu_browsea eq "none"}block{else}none{/if};">{if $site_theme eq "black"}<img src="{$img_url}/bottomcorners2.gif" width="{$thimgwidth}" height="6" alt="">{else}<img src="{$img_url}/bottomcorners.gif" width="{$thimgwidth}" height="6" alt="">{/if}</div>
		    </td>
		</tr>
                {/if}