<table cellpadding=0 cellspacing=0 border=0 width="100%" align="left">
                    ...
                    {if $sbtn eq "mysubs"}
                        <td class="nopad" align="right">
                            <table cellpadding="3" cellspacing="0">
                                <tr>
                                    {if $smarty.request.pkey ne ""}<td><form name="vplshare"><input type="button" name="vplshare" class="fb" style="width: 110px;" value="{$plist_txt45}" onclick="window.open('{$base_url}/share_image_playlist/{$smarty.request.pkey}', 'pshare', 'top=25,left=0,width=640,height=480,resizable=0');"></form></td>{/if}
	...
	<td>
		...
		<form name="filesel" method="post" action="">
		    <table cellpadding=5 cellspacing=1 border=0 width="100%">
            	    {if $sbtn eq "mysubs" and $imgs[0].vid ne ""}
                	<tr>
	...
	<td>
    		...
    		<form name="gifilesel" method="post" action="">
				...
				<table cellpadding=5 cellspacing=1 border=0 align=center>
            			{if $imgs[0].vid ne "" and $sbtn eq "mysubs"}
                		    <tr>
	...
	<td>
		...
		<tr>
			...
			{if $totali eq "0"}{$mypl_imagenone}{else}{$linki}{/if}
		    {else}
			{$link}
		    {/if}
		    </td>
