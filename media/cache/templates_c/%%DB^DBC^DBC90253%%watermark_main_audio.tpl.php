<?php /* Smarty version 2.6.26, created on 2009-11-10 15:26:42
         compiled from administration/watermark_main_audio.tpl */ ?>
<!-- BEGIN ADMIN AREA WATERMARK MAIN TABLE -->
<br>
<table cellspacing="0" cellpadding="2"  width="950" border=0 align=center>
    <tr>
	<td class=""><h1><?php echo $this->_tpl_vars['adm_play_alogoheading']; ?>
</h1></td>
...
/watermark_audio/add'; return false;">
				</td>
			    </tr>
			</table><br>
		    </td>
...
/watermark_audio/enable/<?php echo $this->_tpl_vars['watermark'][$this->_sections['i']['index']]['wid']; ?>
...
/watermark_audio/disable/<?php echo $this->_tpl_vars['watermark'][$this->_sections['i']['index']]['wid']; ?>
...
/watermark_audio/edit/<?php echo $this->_tpl_vars['watermark'][$this->_sections['i']['index']]['wid']; ?>
"><?php echo $this->_tpl_vars['adm_play_vlogoaction3']; ?>
</a><?php echo $this->_tpl_vars['myfiles_delim']; ?>

    		    <a href="<?php echo $this->_tpl_vars['admin_url']; ?>
/watermark_audio/delete/<?php echo $this->_tpl_vars['watermark'][$this->_sections['i']['index']]['wid']; ?>
