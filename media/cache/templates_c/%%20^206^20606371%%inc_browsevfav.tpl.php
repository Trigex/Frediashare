<?php /* Smarty version 2.6.26, created on 2009-11-10 15:21:42
         compiled from _inc/inc_browsevfav.tpl */ ?>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td valign="middle" class="pl5" width="11">
                                                    <div id="cdownarr2f" style="display: <?php if ($_SESSION['menu_browsev'] == 'block' || $_SESSION['menu_browsev'] == ""): ?>block<?php else: ?>none<?php endif; ?>;" class="pl2">
                                                        <a href="javascript:void(0)" onclick="c_m2f(); set_hpsess('menu_browsev');"><img src="<?php echo $this->_tpl_vars['img_url']; ?>
/arrowdown1.gif" width="9" height="5" alt=""></a>
                                                    </div>
                                                    <div id="cleftarr2f" style="display: <?php if ($_SESSION['menu_browsev'] == 'none'): ?>block<?php else: ?>none<?php endif; ?>;" class="pl2">
                                                        <a href="javascript:void(0)" onclick="c_m2f(); set_hpsess('menu_browsev');"><img src="<?php echo $this->_tpl_vars['img_url']; ?>
/arrowleft1.gif" width="5" height="9" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>&nbsp;<a href="javascript:void(0)" onclick="c_m2f(); set_hpsess('menu_browsev');"><span id="mmh12f" class="<?php if ($_SESSION['menu_browsev'] == 'none'): ?><?php else: ?>act<?php endif; ?>"><?php echo $this->_tpl_vars['mmenu_item5']; ?>
</span></a></td>
                                            </tr>
                                        </table>
                                        <div id="cspacer2f" style="display: <?php echo $_SESSION['menu_browsev']; ?>
;"><table cellpadding="0" cellspacing="0"><tr><td height="5"></td></tr></table></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <?php if ($_REQUEST['user'] != ""): ?><?php $this->assign('ulnk', 'user_'); ?><?php $this->assign('rem', "user_videos/"); ?><?php else: ?><?php $this->assign('rem', 'videos'); ?><?php endif; ?>
                        <div id="mmenulist2f" style="display: <?php echo $_SESSION['menu_browsev']; ?>
;">
...
/<?php if ($_REQUEST['category'] != ""): ?>categories/video/<?php echo $_REQUEST['category']; ?>
<?php else: ?><?php echo $this->_tpl_vars['ulnk']; ?>
videos<?php endif; ?><?php if ($_REQUEST['user'] != ""): ?>/<?php echo $_REQUEST['user']; ?>
...
<?php endif; ?>/random<?php endif; ?>"><?php echo $this->_tpl_vars['random']; ?>
                        ...
                        <div align="center" id="cbottom2f" style="display: <?php if ($_SESSION['menu_browsev'] == 'none'): ?>block<?php else: ?>none<?php endif; ?>;"><?php if ($this->_tpl_vars['site_theme'] == 'black'): ?><img src="<?php echo $this->_tpl_vars['img_url']; ?>
