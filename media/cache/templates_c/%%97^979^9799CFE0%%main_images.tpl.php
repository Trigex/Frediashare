<?php /* Smarty version 2.6.26, created on 2009-11-10 15:41:27
         compiled from main_images.tpl */ ?>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <td width="20%" align="right"><?php if ($_SESSION['UID'] != "" || $this->_tpl_vars['guests_file_sorting'] == '1'): ?><?php if ($this->_tpl_vars['total'] != '0'): ?><?php echo $this->_tpl_vars['images_nr']; ?>
[<?php echo $this->_tpl_vars['start_num']; ?>
-<?php echo $this->_tpl_vars['end_num']; ?>
]<?php echo $this->_tpl_vars['images_of']; ?>
