<?php /* Smarty version 2.6.26, created on 2009-11-10 15:21:41
         compiled from _inc/inc_browsei.tpl */ ?>
				...
				<tr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<td valign="middle" class="pl5" width="11">
						    <div id="cdownarr" style="display: <?php if ($_SESSION['menu_browsei'] == 'block' || $_SESSION['menu_browsei'] == ""): ?>block<?php else: ?>none<?php endif; ?>;" class="pl2">
							<a href="javascript:void(0)" onclick="c_m1(); set_hpsess('menu_browsei');"><img src="<?php echo $this->_tpl_vars['img_url']; ?>
/arrowdown1.gif" width="9" height="5" alt=""></a>
						    </div>
						    <div id="cleftarr" style="display: <?php if ($_SESSION['menu_browsei'] == 'none'): ?>block<?php else: ?>none<?php endif; ?>;" class="pl2">
							<a href="javascript:void(0)" onclick="c_m1(); set_hpsess('menu_browsei');"><img src="<?php echo $this->_tpl_vars['img_url']; ?>
/arrowleft1.gif" width="5" height="9" alt=""></a>
						    </div>
						</td>
						<td>&nbsp;<a href="javascript:void(0)" onclick="c_m1(); set_hpsess('menu_browsei');"><span id="mmh1" class="<?php if ($_SESSION['menu_browsei'] == 'none'): ?><?php else: ?>act<?php endif; ?>"><?php echo $this->_tpl_vars['mmenu_item4']; ?>
</span></a></td>
					    </tr>
					</table>
					<div id="cspacer" style="display: <?php echo $_SESSION['menu_browsei']; ?>
;"><table cellpadding="0" cellspacing="0"><tr><td height="5"></td></tr></table></div>
			...
			<div id="mmenulist" style="display: <?php echo $_SESSION['menu_browsei']; ?>
;">
...
<?php endif; ?>/random<?php endif; ?>"><?php echo $this->_tpl_vars['random']; ?>
			...
			<div align="center" id="cbottom" style="display: <?php if ($_SESSION['menu_browsei'] == 'none'): ?>block<?php else: ?>none<?php endif; ?>;"><?php if ($this->_tpl_vars['site_theme'] == 'black'): ?><img src="<?php echo $this->_tpl_vars['img_url']; ?>
