...
$Config['UserFilesPath'] = "$config[base_url]/administration/fckeditor/uploaded_files/";
...
$Config['UserFilesAbsolutePath'] = "$config[base_dir]/administration/fckeditor/uploaded_files/";
