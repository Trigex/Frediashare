...
function ReverseSign(d){
    if ( document.getElementById('img'+d).src == baseurl+'modules/themes/orange/images/sign_plus.gif' )
    {
        document.getElementById('img'+d).src = baseurl+'modules/themes/orange/images/sign_minus.gif';
        document.getElementById('memb'+d).style.color = "#4d4d4d";
    }
    else 
    {
	document.getElementById('img'+d).src = baseurl+'modules/themes/orange/images/sign_plus.gif';
...
if(document.getElementById(d).style.display == "none") 
    	...
    	if (d=="sdiv")
	{
      ...
      document.getElementById(d).style.display = "block"; 
      if(d == "msgopts") { document.getElementById('opts').src = baseurl+'/modules/themes/orange/images/sign_minus.gif'; }
      if(d == "adv_set")
      {
        document.getElementById('opts').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
	document.getElementById('opts_txt').style.color = "#4d4d4d";
      }
...
//      if(d == "video_conv")
//      {
//        document.getElementById('optsv').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
//	document.getElementById('opts_txtv').style.color = "#4d4d4d";
//      }
//      if(d == "file_set")
//      {
//        document.getElementById('optsf').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
//	document.getElementById('opts_txtf').style.color = "#4d4d4d";
//      }
//      if(d == "thumb_set")
//      {
//        document.getElementById('optst').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
//	document.getElementById('opts_txtt').style.color = "#4d4d4d";
//      }
      if(d == "rstats")
      {
        document.getElementById('optsf').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
	document.getElementById('opts_txtf').style.color = "#4d4d4d";
      ...
      {
        document.getElementById('opts').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
	document.getElementById('opts_txt1').style.color = "#4d4d4d";
      }
      if(d == "site_statsa")
      {
        document.getElementById('statsa').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
        document.getElementById('sitestatsa').style.color = "#4d4d4d";
      }
      if(d == "site_statsi")
      {
        document.getElementById('statsi').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
        document.getElementById('sitestatsi').style.color = "#4d4d4d";
      }
      if(d == "site_statsv")
      {
        document.getElementById('statsv').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
        document.getElementById('sitestatsv').style.color = "#4d4d4d";
      }
      if(d == "site_statsg")
      {
        document.getElementById('statsg').src = baseurl+'/modules/themes/orange/images/sign_minus.gif';
        document.getElementById('sitestatsg').style.color = "#4d4d4d";
      }
      if(d == "recoverpass")
      {
        document.getElementById('fptxt').style.color = "#4d4d4d";
      }
    }
else 
    { 
      document.getElementById(d).style.display = "none"; 
      if(d == "msgopts") { document.getElementById('opts').src = baseurl+'/modules/themes/orange/images/sign_plus.gif'; }
      if(d == "adv_set")
      {
        document.getElementById('opts').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
...
//      if(d == "video_conv")
//      {
//        document.getElementById('optsv').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
//	document.getElementById('opts_txtv').style.color = "";
//      }
//      if(d == "file_set")
//      {
//        document.getElementById('optsf').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
//	document.getElementById('opts_txtf').style.color = "";
//      }
//      if(d == "thumb_set")
//      {
//        document.getElementById('optst').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
...
//      }
	...
	document.getElementById('opts_txtf').style.color = "";
      ...
      {
        document.getElementById('opts').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
	document.getElementById('opts_txt1').style.color = "#BF4D02";
      }
      if(d == "site_statsa")
      {
        document.getElementById('statsa').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
        document.getElementById('sitestatsa').style.color = "";
      }
      if(d == "site_statsi")
      {
        document.getElementById('statsi').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
        document.getElementById('sitestatsi').style.color = "";
      }
      if(d == "site_statsv")
      {
        document.getElementById('statsv').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
        document.getElementById('sitestatsv').style.color = "";
      }
      if(d == "site_statsg")
      {
        document.getElementById('statsg').src = baseurl+'/modules/themes/orange/images/sign_plus.gif';
...
if(document.getElementById(d).style.display == "none") 
	...
	if (d=="audios")
	{
	    ...
	    document.getElementById(d).style.display = "block";
	    var a = new getObj('saudio'); a.style.color = "#4d4d4d";
	...
	if (d=="images")
	{
	    ...
	    document.getElementById('tags').style.display = "none";
	    document.getElementById(d).style.display = "block";
	    var a = new getObj('simage'); a.style.color = "#4d4d4d";
	...
	if (d=="videos")
	{
	    ...
	    document.getElementById('tags').style.display = "none";
	    document.getElementById(d).style.display = "block";
	    var a = new getObj('svideo'); a.style.color = "#4d4d4d";
	    var b = new getObj('saudio'); b.style.color = "";
	...
	if (d=="members")
	{
	    ...
	    document.getElementById('tags').style.display = "none";
	    document.getElementById(d).style.display = "block";
	    var a = new getObj('smember'); a.style.color = "#4d4d4d";
	    var b = new getObj('saudio'); b.style.color = "";
	    var c = new getObj('simage'); c.style.color = "";
	...
	if (d=="tags")
	{
	    ...
	    document.getElementById('members').style.display = "none";
	    document.getElementById(d).style.display = "block";
	    var a = new getObj('stags'); a.style.color = "#4d4d4d";
	    var b = new getObj('saudio'); b.style.color = "";
	    var c = new getObj('simage'); c.style.color = "";
	    var d = new getObj('svideo'); d.style.color = "";
